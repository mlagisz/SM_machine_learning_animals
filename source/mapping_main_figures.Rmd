...
This script creates files with the figures for the main text of the manuscript. it is not intended to be knitted.
...
fig1B <- Studied_species_type_sep %>% 
  ...
  theme_classic() +
  scale_fill_manual(values=rev(c("#CF4E9C", "#B66DFF", "#006DDB", "#490092", "#009292", "#DB6D00", "#924900"))) +
...
#Studied_species_type custom colors: "amphibians" = "#009292", "birds" = "#B66DFF","fishes" = "#006DDB", "mammals" = "#CF4E9C", "other" = "#924900", "reptiles" = "#490092", "unclear" = "#DB6D00")# #assign colors to biological groups, https://r-charts.com/color-palettes/ using paletteer_d("colorBlindness::paletteMartin")

 rawdata_incl %>% filter(Species_number == "1") %>% 
   filter(Study_species != "unclear") %>% select(Study_species, Studied_species_type) %>%
   unique() %>% mutate(species_cols = recode(Studied_species_type, "amphibians" = "#009292", "birds" = "#B66DFF","fishes" = "#006DDB", "mammals" = "#CF4E9C", "other" = "#924900", "reptiles" = "#490092", "unclear" = "#DB6D00")) -> species_colors_table
...
fig1C <- rawdata_incl %>% filter(Species_number == "1") %>% 
  ...
  theme_classic() +
  scale_fill_manual(labels = c("fishes", "reptiles", "birds", "mammals"), values = c("#006DDB", "#490092", "#B66DFF", "#CF4E9C")) +
...
color_bgroup <- recode(myspecies_data$biological_group, "fishes" = "#006DDB", "mammals" = "#CF4E9C")
...
p_inset <- as.ggplot(function() {
  ...
  add_phylopic_base(Salmo, x = 60, y = 13, ysize = 0.8, xsize = 8, color = "#006DDB", alpha = 0.6)
  add_phylopic_base(Panthera, x = 60, y = 12, ysize = 1, xsize = 12, color = "#CF4E9C", alpha = 0.7)
  add_phylopic_base(Pusa,x = 60, y = 11, ysize = 1, xsize = 10, color = "#CF4E9C", alpha = 0.7)
  add_phylopic_base(Ailuropoda, x = 60, y = 10, ysize = 1, xsize = 6, color = "#CF4E9C", alpha = 0.7)
  add_phylopic_base(Ursus, x = 60, y = 9, ysize = 1, xsize = 11, color = "#CF4E9C", alpha = 0.7)
  add_phylopic_base(Eubalaena, x = 60, y = 8, ysize = 1, xsize = 12, color = "#CF4E9C", alpha = 0.7)
  add_phylopic_base(Megaptera, x = 60, y = 7, ysize = 1, xsize = 10, color = "#CF4E9C", alpha = 0.7)
  add_phylopic_base(Sousa, x = 60, y = 6, ysize = 1, xsize = 10, color = "#CF4E9C", alpha = 0.7)
  add_phylopic_base(Cephalorhynchus, x = 60, y = 5, ysize = 1, xsize = 12, color = "#CF4E9C", alpha = 0.7)
  add_phylopic_base(Grampus, x = 60, y = 4, ysize = 1, xsize = 12, color = "#CF4E9C", alpha = 0.7)
  add_phylopic_base(Gorilla, x = 60, y = 3, ysize = 1, xsize = 6, color = "#CF4E9C", alpha = 0.7)
  add_phylopic_base(Pan, x = 60, y = 2, ysize = 0.8, xsize = 6, color = "#CF4E9C", alpha = 0.7)
  add_phylopic_base(Macaca, x = 60, y = 1, ysize = 1, xsize = 8, color = "#CF4E9C", alpha = 0.7)
  text(84, 14, "Article count", cex=1) #col = "#325F8C", 
  text(21, 14, "Species", cex=1) #col = "#325F8C", 
  title("Individual recognition (re-identification)")
  box(col = "grey", lwd = 2, which = "figure")# Add box to plot
    }
)
...
fig1A / fig1B / fig1C + inset_element(p_inset, left = 0.35, bottom = 0.01, right = 0.99, top = 0.75) +
  ...
  theme(plot.tag.position = c(0.01,0.99), plot.tag = element_text(size = 14, face = "bold"))

#save the figure 
ggsave(here("plots", "Figure1_v0.pdf"), width = 16, height = 20, units = "cm", dpi = 300, scale=1.8)
```
...
fig2A <- Image_source_type_sep %>% 
  ...
  scale_x_discrete(labels=c("other / unclear", "aerial / drone", "hand / mobile camera", "fixed camera")) +
...
#save the figure 
ggsave(here("plots", "Figure2_v0.pdf"), width = 16, height = 10, units = "cm", dpi = 300, scale=1.8)
```
...
fig3B <- Algorithm_type_sep %>% 
  ...
  geom_area() +
  theme_classic() +
  theme(legend.position = "left", legend.direction = "vertical", plot.margin = margin(t = 40, r = 0, b = 20, l = 10)) + 
...
#save the figure 
ggsave(here("plots", "Figure3_v0.pdf"), width = 16, height = 12, units = "cm", dpi = 300, scale=1.8)
```
...
fig4B <- ggplot() + 
  ...
  labs(title = "How first author and location of images overlap?", caption = "circles = overlapping locations (scaled by count), arrows = non-overlapping locations (image -> author)")
...
#save the figure 
ggsave(here("plots", "Figure4_v0.pdf"), width = 16, height = 20, units = "cm", dpi = 300, scale=1.8)
```
...
fig5A <- rawdata_incl %>% 
  ...
  scale_fill_manual(values = c("#24325F", "#526E2D", "#B7E4F9"))+ 
...
fig5B <- count(rawdata_incl, Journal) %>%
 ...
 # geom_text(aes(label = scales::comma(n)), hjust = 0, nudge_y = 1) +
  ...
  coord_flip() +
  scale_y_continuous(breaks = seq(0, 20, 1)) +
  scale_fill_manual(values = c("#B7E4F9", "#B7E4F9", "#526E2D", "#B7E4F9", "#B7E4F9", "#526E2D","#B7E4F9", "#526E2D", "#526E2D")) + 
...
#save the figure 
ggsave(here("plots", "Figure5_v0.pdf"), width = 16, height = 10, units = "cm", dpi = 300, scale=1.8)
```
...
#save the figure 
ggsave(here("plots", "Figure6_v0.pdf"), width = 16, height = 8, units = "cm", dpi = 300, scale=1.8)
```
