...
We used GoogleSheet to record data checks and any additional comments. There, we also recoded whether a given paper was used in the pilot rounds, and if it was included or excluded from the final dataset, with a note on the main reason for exclusion.  
...
bib <- convert2df(here("data", "scopus_included_records_2021_updated.bib"), dbsource = "wos", format = "bibtex") 
